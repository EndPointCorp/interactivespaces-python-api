...
master = interactivespaces.Master('127.0.0.1', '8080', '8090')
...
#    },
    '42-a controller' : {
        'VIEWPORT' : 'left_two',
        'GUI_HIDDEN' : 'false',
        'VIEWSYNC1' : '-style GTK+ -sConnection/disableRequestBatching=true -sViewSync/receive=true -sViewSync/hostname=10.42.42.255 -sViewSync/port=45678',
        'VIEWSYNC2' : '-sViewSync/yawOffset=-36 -sViewSync/pitchOffset=0 -sViewSync/rollOffset=0 -sViewSync/horizFov=29 -multiple',
        'VIEWSYNC3' : '',
        'VIEWSYNC4' : '',
        'SPACENAV' : 'false',
        'SPACENAV_1' : '',
    ...
    '42-b controller' : {
        ...
        'GUI_HIDDEN' : 'false',
        'VIEWSYNC1' : '-style GTK+ -sConnection/disableRequestBatching=true -sViewSync/receive=true -sViewSync/hostname=10.42.42.255 -sViewSync/port=45678',
        'VIEWSYNC2' : '-sViewSync/yawOffset=-18 -sViewSync/pitchOffset=0 -sViewSync/rollOffset=0 -sViewSync/horizFov=29 -multiple',
        'VIEWSYNC3' : '',
        'VIEWSYNC4' : '',
        'SPACENAV' : 'false',
        'SPACENAV_1' : '',
    ...
    '42-c controller' : {
        ...
        'GUI_HIDDEN' : 'false',
        'VIEWSYNC1' : '-style GTK+ -sConnection/disableRequestBatching=true -sViewSync/receive=true -sViewSync/hostname=10.42.42.255 -sViewSync/port=45678',
        'VIEWSYNC2' : '-sViewSync/yawOffset=0 -sViewSync/pitchOffset=0 -sViewSync/rollOffset=0 -sViewSync/horizFov=29 -multiple',
        'VIEWSYNC3' : '',
        'VIEWSYNC4' : '',
        'SPACENAV' : 'false',
        'SPACENAV_1' : '',
    ...
    'touchscreen controller' : {
        ...
        'VIEWSYNC1' : '-style GTK+ -sConnection/disableRequestBatching=true -sViewSync/send=true',
        'VIEWSYNC3' : '-sViewSync/hostname=10.42.42.255 -sViewSync/port=45678',
        'VIEWSYNC2' : '-sViewSync/yawOffset=0 -sViewSync/pitchOffset=0 -sViewSync/rollOffset=0',
        'VIEWSYNC4' : '-sViewSync/horizFov=29',
    },
    '42-d controller' : {
        'VIEWPORT' : 'right_one',
        'GUI_HIDDEN' : 'false',
...
config = {
    ...
    'Query service' : {
        'name' : 'Google Earth Query Interface',
        'jar' : 'jars/com.endpoint.lg.earth.query-1.0.0.dev.zip',
        'config' : 'jars/query-service.conf',
        'liveactivitygroup' : 'Query services',
        'liveactivities' : [
            { 'name' : 'Query service', 'each_controller' : '42*' }
        ]
    },
    'Message Tester' : {
        'name' : 'Message Tester',
        'jar' : 'jars/com.endpoint.messageTester-0.0.1.zip',
        'config' : 'jars/query-service.conf',
        'liveactivities' : [
            { 'name' : 'Message tester', 'controller_name' : '*head*' }
        ]
    },
}
